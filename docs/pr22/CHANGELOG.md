...
Fixture, demonstração humana, E2E autenticado, testes unitários, typechecks, contratos, builds, budget e scanner de privacidade passaram. O CI oficial da PR concluiu 14/14 checks verdes; o run e o SHA finais estão registrados na PR aberta. O replay integral de migrations falha em migration histórica anterior à PR22 e o lint global mostra dívida legada; por isso o status operacional final é `NO-GO PARA MERGE/DEPLOY` até decisão separada sobre esses gates.
