...
export default function FamilyGuardiansPage() {
  ...
  return (
    <PageShell title="Vínculos familiares" subtitle="Vínculos e consentimentos.">
      <div className="space-y-6">
        <div className="rounded-2xl border border-emerald-100 bg-emerald-50/70 px-4 py-3 text-sm text-emerald-900"><ShieldCheck className="mr-2 inline h-4 w-4" /> Acesso limitado às crianças vinculadas.</div>
        ...
        <footer className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-500"><CheckCircle2 className="mr-1 inline h-4 w-4 text-emerald-600" /> Sem contas automáticas. Saúde protegida.</footer>
      </div>
    </PageShell>
  );
}
