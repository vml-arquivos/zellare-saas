...
export default function DashboardMantenedoraPremium() {
  ...
  if (loading) return <div className="flex min-h-screen items-center justify-center bg-[var(--surface-page)] text-primary">Carregando dados reais do painel...</div>;
