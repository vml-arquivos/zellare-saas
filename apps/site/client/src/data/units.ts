// ============================================================================
// DADOS ESTÁTICOS DAS UNIDADES Zelare
...
export const UNITS_STATIC: UnitData[] = [
  {
    ...
    emailPublic: 'cepiarara@zelare.com.br',
