 ...
 * Pode ser rodado múltiplas vezes sem efeitos colaterais.
 */
...
async function main() {
  ...
  console.log(`\n📊 Unidades existentes para mantenedoraId=${mantenedoraId}: ${unidadesExistentes.length}`);
  ...
  console.log('📋 Unidades finais no banco:');
